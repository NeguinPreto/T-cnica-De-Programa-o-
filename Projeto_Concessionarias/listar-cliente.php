    ...
    if ($qtd > 0) {
        ...
        while ($row = $res->fetch_object()) {
			...
			print "<td>
                    ...
                    <button class='btn btn-danger' onclick=\"if(confirm('Ten certeza que deseja excluir?')){location.href='?page=salvar-cliente&acao=excluir&id_cliente={$row->id_cliente}';}else{false;}\">excluir</button>
